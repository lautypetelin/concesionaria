...
public class ModificarAutomovil extends javax.swing.JFrame {
    ...
    public ModificarAutomovil(int idAuto) {
        ...
        auto = control.traerAutomovil(idAuto);
        initComponents();
        llenarCampos();
    }
    ...
    private void initComponents() {
        ...
        jlTitulo.setText("Modificación de Automóviles");
        ...
        jbGuardarCambios.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(44, 44, 44)
                                .addComponent(jbGuardarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(28, 28, 28)
    ...
    private void jbGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarCambiosActionPerformed
        ...
        try{
            ...
            control.modificarAutomovil(auto, marca, modelo, color, motor, patente, cantPuertas);

            JOptionPane.showMessageDialog(this, "Automóvil modificado correctamente.", "Información", 1);
    ...
    private void llenarCampos() {
        ...
        jtfCantPuertas.setText(String.valueOf(auto.getCantidadPuertas()));
    }
}
